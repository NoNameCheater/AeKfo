package net.aekfo.aekfomod;

import net.aekfo.aekfomod.block.ModBlocks;
import net.aekfo.aekfomod.item.ModCreativeTabs;
...
@Mod(AeKfoMod.MOD_ID)
public class AeKfoMod {
    public static final String MOD_ID = "aekfomod";
    private static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public AeKfoMod(IEventBus modEventBus, ModContainer modContainer) {
